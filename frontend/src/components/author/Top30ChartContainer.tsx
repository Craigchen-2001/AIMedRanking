// // /Users/chenweichi/ICLR_2025_Project/ICLR_2025_Project/frontend/src/components/author/Top30ChartContainer.tsx
...
export default function Top30ChartContainer({ papers }: { papers: PaperItem[] }) {
  const years = useMemo(() => getAllYears(papers), [papers]);
