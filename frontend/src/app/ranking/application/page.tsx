...
export default function ApplicationRankingPage() {
  return (
    <div className="pt-20">
      <header className="fixed top-0 left-0 right-0 z-50 bg-red-800 h-20 flex items-center justify-between px-6 border-b">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 text-white text-xl font-semibold">Application</div>
        <Link href="/" className="text-white hover:underline text-sm">← Back to Home</Link>
      </header>
