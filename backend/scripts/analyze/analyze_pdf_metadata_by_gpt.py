...
def main():
    ...
    prompt_path = "prompts/pdf_extraction_instruction.txt"
    fewshot_path = "prompts/few_shot_examples.md"
    output_json = "outputs/ICLR/analyze_healthcare/ICLR_2025_TestTopic_pdf_metadata.json"
