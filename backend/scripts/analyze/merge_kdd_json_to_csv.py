...
# === Configuration ===
INPUT_DIR = "/Users/chenweichi/ICLR_2025_Project/ICLR_2025_Project/data/KDD/metadata"
OUTPUT_DIR = "/Users/chenweichi/ICLR_2025_Project/ICLR_2025_Project/outputs/KDD/allof_CSV"
os.makedirs(OUTPUT_DIR, exist_ok=True)
OUTPUT_CSV_PATH = os.path.join(OUTPUT_DIR, "KDD_Metadata_Merged.csv")
...
for year in range(2020, 2026):
    json_path = os.path.join(INPUT_DIR, f"kdd_metadata_{year}.json")
